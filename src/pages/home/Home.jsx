...
const Home = () => {
  return (
    <div className='bg-[#B1E3FA] xl:h-[600px] rounded-[35px] flex justify-between items-center px-6 sm:px-5 xl:gap-10 sm:flex-col sm:h-[90vh] sm:py-[37px] sm:rounded-2xl '>
