...
const Home = () => {
  return (
    <div className='bg-[#B1E3FA] xl:h-[600px] rounded-[35px] flex justify-between items-center px-6 sm:px-3 xl:gap-10 sm:flex-col sm:gap-[50px] sm:py-[37px] sm:rounded-2xl '>
